...
This Code of Conduct applies within all community spaces — the repository's issues, pull
requests, discussions and code review — and also applies when an individual is officially
...
Alternatively, contact [@jeffreymooiweer](https://github.com/jeffreymooiweer) through
GitHub.

All complaints will be reviewed and investigated promptly and fairly. The privacy and
security of the reporter will be respected.

## Enforcement guidelines

The maintainer will follow these guidelines in determining the consequences of any action
judged to be in violation of this Code of Conduct:

### 1. Correction

**Impact:** Use of inappropriate language or other behaviour deemed unprofessional or
unwelcome.
...
**Impact:** A serious violation of community standards, including sustained inappropriate
behaviour.
...
The enforcement guidelines were inspired by
