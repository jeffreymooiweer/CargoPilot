...
#: What the message says. Plain, short, and explicit about the one thing the
#: reader must be able to decide: whether they asked for this.
SUBJECT = "Reset your CargoPilot password"

BODY = (
    "Somebody asked to reset the password of the CargoPilot account "
    "'{username}'.\n\n"
    "Open this link to choose a new password:\n\n"
    "{link}\n\n"
    "The link works once and expires in {minutes} minutes.\n\n"
    "If this was not you, nothing has happened yet and you can ignore this "
